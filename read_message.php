                                ...
                                <div class="mini all">
                                    <header>
                                        <section>
                                            ...
                                            <br>
                                            <small><strong>From:</strong> <?php echo $from_user->get_user_full_name() ." &lt".$from_user->email."&gt"; ?></small>
                                            <br>
                                            <small><strong>To:</strong> <?php echo $to_user->get_user_full_name() ." &lt".$to_user->email."&gt"; ?></small>
                                        </section>
                                    </header>
                                    <hr>
                                </div>
